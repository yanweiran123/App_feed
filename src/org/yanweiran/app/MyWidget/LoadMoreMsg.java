...
public class LoadMoreMsg extends ListView implements OnScrollListener {
    ...
    public LoadMoreMsg(Context context) {
        super(context);
        init(context);
    }

    public LoadMoreMsg(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
